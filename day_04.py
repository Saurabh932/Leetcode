'''
    ...
    Announce the victory: If this senator found the senators who still have rights to vote are all from the same party, h
    e can announce the victory and decide on the change in the game.
...
senate = input("Enter the string: ")
print("The victor is: ", predictPartyVictory(senate))
